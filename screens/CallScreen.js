...
export default function CallScreen({navigation, ...props}) {
  ...
  //const [conn, setConn] = useState(new WebSocket('http://192.168.0.102:1445/'));
  const [conn, setConn] = useState(new WebSocket('http://185.95.213.20:1444/'));
  ...
  useEffect(() => {
    ...
    conn.onmessage = (msg) => {
      ...
      if (msg.data === 'Hello world') {
        ...
        // InCallManager.start({media: 'audio', ringback: 'ring.mp3'});
